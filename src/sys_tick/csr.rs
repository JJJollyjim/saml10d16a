...
impl crate::ToBits<bool> for ENABLE_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
            ENABLE_A::VALUE_0 => false,
            ENABLE_A::VALUE_1 => true,
        }
    }
}
...
impl crate::ToBits<bool> for TICKINT_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
            TICKINT_A::VALUE_0 => false,
            TICKINT_A::VALUE_1 => true,
        }
    }
}
...
impl crate::ToBits<bool> for CLKSOURCE_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
            CLKSOURCE_A::VALUE_0 => false,
            CLKSOURCE_A::VALUE_1 => true,
        }
    }
}
